...
class UploadWorker(
    ...
    private val channelId = "telegallery_backup_channel"
    ...
    private fun createForegroundInfo(progressText: String): ForegroundInfo {
        ...
        val notification = NotificationCompat.Builder(applicationContext, channelId)
            .setContentTitle("TeleGallery Photo Backup")
    ...
    override suspend fun doWork(): Result {
        ...
        val wakeLock = powerManager.newWakeLock(PowerManager.PARTIAL_WAKE_LOCK, "TeleGallery::BackupWakeLock")
        ...
        val wifiLock = if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q) {
            ...
            wifiManager.createWifiLock(WifiManager.WIFI_MODE_FULL_HIGH_PERF, "TeleGallery::BackupWifiLock")
        } else {
            @Suppress("DEPRECATION")
            wifiManager.createWifiLock(WifiManager.WIFI_MODE_FULL, "TeleGallery::BackupWifiLock")
        }
