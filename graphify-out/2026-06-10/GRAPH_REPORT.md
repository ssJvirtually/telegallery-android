...
## Corpus Check
- 54 files · ~217,065 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 872 nodes · 1328 edges · 68 communities (52 shown, 16 thin omitted)
- Extraction: 94% EXTRACTED · 6% INFERRED · 0% AMBIGUOUS · INFERRED: 80 edges (avg confidence: 0.86)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `c85ba52a`
...
Cohesion: 0.11
Nodes (19): androidx, Boolean, Context, dev, Int, List, LocalPhoto, Set (+11 more)
...
Cohesion: 0.09
Nodes (17): androidx, android, androidx, List, LocalPhoto, File, Float, String (+9 more)
...
Cohesion: 0.09
Nodes (18): File, Application, Boolean, CloudPhotoEntity, Flow, List, LocalPhoto, SearchItem (+10 more)

### Community 57 - "Community 57"
Cohesion: 0.13
Nodes (12): AndroidViewModel, Boolean, Long, StateFlow, Flow, List, LocalPhoto, SearchItem (+4 more)
...
Cohesion: 0.26
Nodes (8): AlbumEntity, AlbumPhotoEntity, Flow, List, LocalPhoto, Long, String, AlbumViewModel

## Knowledge Gaps
- **347 isolated node(s):** `ManagedActivityResultLauncher`, `IntentSenderRequest`, `androidx`, `android`, `Bundle` (+342 more)
...
- **Why does `PhotosGridScreen()` connect `Photos Grid and Search UI` to `Database and DAO Schema`, `Community 65`, `Community 66`, `Image Upload Manager`, `Community 59`, `Community 60`, `Community 61`?**
  _High betweenness centrality (0.062) - this node is a cross-community bridge._
- **Why does `TdlibManager` connect `Telegram Client Integration` to `Background Backup Workers`?**
  _High betweenness centrality (0.060) - this node is a cross-community bridge._
- **Why does `AppNavigation()` connect `Community 61` to `Community 32`, `Main Activity UI Lifecycle`, `Telegram Client Integration`?**
  _High betweenness centrality (0.060) - this node is a cross-community bridge._
