# Graph Report - telegallery-calude  (2026-06-06)

## Corpus Check
- 40 files · ~200,490 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 621 nodes · 924 edges · 55 communities (38 shown, 17 thin omitted)
- Extraction: 92% EXTRACTED · 8% INFERRED · 0% AMBIGUOUS · INFERRED: 78 edges (avg confidence: 0.86)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `d9deaef7`
...
5. `PhotosGridScreen()` - 21 edges
6. `BackupManager` - 20 edges
7. `📝 TGPix Android — Version Release Changelog` - 15 edges
8. `AlbumDao` - 14 edges
9. `TGPix — Backup Strategy Production Review` - 14 edges
10. `CloudPhotoDao` - 13 edges
...
Cohesion: 0.07
Nodes (47): androidx, Context, Int, List, LocalPhoto, Long, String, Boolean (+39 more)
...
## Knowledge Gaps
- **245 isolated node(s):** `ManagedActivityResultLauncher`, `IntentSenderRequest`, `androidx`, `Bundle`, `List` (+240 more)
