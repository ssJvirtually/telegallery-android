...
Cohesion: 0.10
Nodes (28): app/build.gradle, Boolean, Context, Int, List, Long, StateFlow, String (+20 more)
...
## Knowledge Gaps
- **278 isolated node(s):** `ManagedActivityResultLauncher`, `IntentSenderRequest`, `androidx`, `android`, `Bundle` (+273 more)
