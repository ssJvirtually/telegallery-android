...
## Corpus Check
- 49 files · ~212,049 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 779 nodes · 1204 edges · 65 communities (49 shown, 16 thin omitted)
- Extraction: 93% EXTRACTED · 7% INFERRED · 0% AMBIGUOUS · INFERRED: 80 edges (avg confidence: 0.86)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `e37e5acb`
...
## Knowledge Gaps
- **305 isolated node(s):** `ManagedActivityResultLauncher`, `IntentSenderRequest`, `androidx`, `android`, `Bundle` (+300 more)
...
- **Why does `PhotosGridScreen()` connect `Photos Grid and Search UI` to `Database and DAO Schema`, `Albums Screen UI and Utils`, `Image Upload Manager`, `Community 57`, `Community 60`?**
  _High betweenness centrality (0.075) - this node is a cross-community bridge._
- **Why does `AppNavigation()` connect `Community 60` to `Community 32`, `Community 59`, `Telegram Client Integration`, `Community 31`?**
  _High betweenness centrality (0.073) - this node is a cross-community bridge._
- **Why does `AutoVaultSetupScreen()` connect `Telegram Client Integration` to `Application Preferences`, `Community 60`?**
