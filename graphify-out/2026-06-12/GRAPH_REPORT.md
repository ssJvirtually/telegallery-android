...
## Corpus Check
- 51 files · ~211,855 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1041 nodes · 1705 edges · 76 communities (59 shown, 17 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 86 edges (avg confidence: 0.86)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `accce2a9`
...
Cohesion: 0.15
Nodes (4): Boolean, Int, CloudPhotoDao, CloudPhotoEntity
...
## Knowledge Gaps
- **415 isolated node(s):** `ManagedActivityResultLauncher`, `IntentSenderRequest`, `androidx`, `android`, `Bundle` (+410 more)
...
- **Why does `AppNavigation()` connect `Community 74` to `Community 73`, `Telegram Client Integration`, `Community 70`, `Community 71`?**
