...
│   ├── java/com/tgpix/
│   │   ├── MainActivity.kt
│   │   ├── TGPixApp.kt                  ← Hilt Application class
│   │   │
│   │   ├── data/
│   │   │   ├── local/
│   │   │   │   ├── db/
...
```xml
<application
    android:name=".TGPixApp"
    android:label="TGPix"
    android:icon="@mipmap/ic_launcher"
    android:theme="@style/Theme.TGPix"
...
*End of TGPix Implementation Plan*
